"""
KNN workflow refactored from Scenario_1.ipynb.
...
def run_hyperband_search(
    ...
    """
    Perform a Hyperband-style search to find a strong KNN configuration.
    """
    max_iter = 81
    eta = 3
...
def plot_learning_curve_knn(
    ...
    plt.ylabel("Score (R²)")
    plt.title("Learning Curve - KNN (K-Nearest Neighbors)")
    plt.legend()
    plt.ylim(0.88, 1.01)
    plt.savefig(output_path, format="jpg", dpi=300, bbox_inches="tight")
    plt.show()
...
def main():
    ...
    plot_learning_curve_knn(
        ...
        x_train=x_train,
        y_train=y_train,
        output_path="knn_learning_curve.jpg",
    )
    ...
    plot_permutation_importance(
        ...
        title="Feature Importance in the KNN Algorithm",
        output_path="knn_feature_importance.jpg",
    )
    ...
    plot_residuals_over_time(
        ...
        title="KNN over Time",
        y_label="N₂O Residuals",
        output_path="knn_residuals_jointplot.jpg",
    )
    ...
    plot_zero_bias_regression(
        ...
        output_path="knn_zero_bias_regression.jpg",
    )
